...
const DEFAULT_PARAMS = {
  grantSize:            '1.0M',
  costPerPersonYear:    '0.42',
  yldsper100k:          '978',
  trialEffect:          '43.00%',
  internalValidity:     '-25.00%',
  externalValidity:     '-21.14%',
  valuePerYLD:          '2.300',
  pctUnder15:           '73.68%',
  anemiaPrev:           '34.30%',
  incomeIncrease:       '0.37%',
...
export default function IronSupplementation() {
    ...
    <div>
      <div className="tab-content-header">
        <div className="tab-content-title">
          Iron Supplementation (India) <span className="multiple">{formatMultiple(c.ceMultiple)}</span>
        </div>
